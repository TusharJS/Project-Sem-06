...
<body>
    ...
    $result = mysqli_query($conn, "select V.vname,V.date,V.time,V.description,M.wing,M.flat,V.image from tbl_visitor V INNER JOIN tbl_member M ON V.mid=M.mid where V.mid IN (select mid from tbl_member where sid = " . $_SESSION['socid'] . ")");  ?>
